...
st.write('Última Atualização 18/06/2024')


# importar os dados

tabela = pd.read_csv('https://raw.githubusercontent.com/Fernando-Almeida23/Pelada_sabado/refs/heads/main/pelada_sabado_2026_02.csv')
